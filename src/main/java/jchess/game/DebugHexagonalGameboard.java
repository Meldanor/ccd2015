...
/**
 * The Kings of all Player will start as neighbours at the following positions:
 * White King: (5,5) Black King: (6,6) Gray King: (5,6)
 */
public class DebugHexagonalGameboard extends HexagonalGameboard {
    ...
    static {
        ...
        figuresMap.put(Position2D.of(5, 5), DefaultFigures.king(HexagonalPlayerType.WHITE));
        ...
        figuresMap.put(Position2D.of(6, 6), DefaultFigures.king(HexagonalPlayerType.BLACK));
        ...
        figuresMap.put(Position2D.of(5, 6), DefaultFigures.king(HexagonalPlayerType.GRAY));
    ...
    public DebugHexagonalGameboard() {
        super(rows, figures);
    }
}
