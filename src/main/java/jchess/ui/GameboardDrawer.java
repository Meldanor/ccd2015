...
public class GameboardDrawer extends JComponent {
    ...
    public void paint(Graphics g) {
        drawRow(g, new Point(185, 35), 8, Position2D.of(0, 0));
        drawRow(g, new Point(154, 89), 9, Position2D.of(1, 0));
        drawRow(g, new Point(123, 143), 10, Position2D.of(2, 0));
        drawRow(g, new Point(92, 197), 11, Position2D.of(3, 0));
        drawRow(g, new Point(61, 251), 12, Position2D.of(4, 0));
        drawRow(g, new Point(30, 305), 13, Position2D.of(5, 0));
        drawRow(g, new Point(61, 359), 12, Position2D.of(6, 1));
        drawRow(g, new Point(92, 413), 11, Position2D.of(7, 2));
        drawRow(g, new Point(123, 467), 10, Position2D.of(8, 3));
        drawRow(g, new Point(154, 521), 9, Position2D.of(9, 4));
        drawRow(g, new Point(185, 575), 8, Position2D.of(10, 5));
        drawRow(g, new Point(216, 629), 7, Position2D.of(11, 6));
        drawRow(g, new Point(247, 683), 6, Position2D.of(12, 7));
    }
     ...
     */
    public void drawRow(Graphics g, Point firstRowFieldCenter, int numOfElementsInRow, Position2D firstPos2D) {
