...
public class Rook extends Piece {
    ...
    public ArrayList allMoves() {
        ...
        for (int i = (this.square.pozY + 1); i <= 7; ++i) {//up
            limiter += 1;
            if (this.checkPiece(this.square.pozX, i) && limiter <=limit) {//if on this sqhuare isn't piece
        ...
        for (int i = this.square.pozX - 1; i >= 0; --i) {//left
            limiter+=1;
            if (this.checkPiece(i, this.square.pozY) && limiter <=limit) {//if on this sqhuare isn't piece
